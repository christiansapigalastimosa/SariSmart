export const SAMPLE_PRODUCTS = [
  { id: 1, name: 'SmartCanteen Combo', price: '₱135.00', label: 'Best seller', desc: 'A complete meal with sandwich, drink, and snack.', details: ['Popular choice', 'Fast pickup', 'Best value'] },
...
export const EXAMPLE_CART_ITEMS = [
  ...
  { id: 1, name: 'SmartCanteen Combo', price: '₱135.00', qty: 1 },
];
