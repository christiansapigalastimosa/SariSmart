...
export default function EditProduct() {
  ...
  async function onSave() {
    ...
    await updateProduct(product.id, {
      ...
      category,
      discount: Number.isFinite(percentDiscount) ? percentDiscount : undefined,
      image,
    });
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.formWrap}>
        ...
        <AppButton title="Delete product" onPress={onDelete} variant="danger" style={[styles.submitButton, { marginTop: 8 }]} />
      </View>
      <ConfirmDialog
